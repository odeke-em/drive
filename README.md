...
- [Using](#using)
  ...
  - [Scripting And Automating](#scripting-and-automating)
...
Installing scripts which offer automated drive commands including syncing is described in [README-Automation.md](https://github.com/odeke-em/drive/blob/master/README-Automation.md).
...
Using scripts which offer automated drive commands including syncing is described in [README-Automation.md](https://github.com/odeke-em/drive/blob/master/README-Automation.md).
